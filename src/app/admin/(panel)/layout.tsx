  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)]">
      <div className="mx-auto flex w-full max-w-7xl gap-6 px-4 py-8">
        <aside className="hidden w-64 shrink-0 rounded-2xl border border-[var(--ds-border)] bg-[var(--color-surface)] p-4 md:block">
          ...
          <form action="/api/admin/logout" method="post" className="mt-4">
            <button
              type="submit"
              className="inline-flex w-fit rounded-full border border-[var(--ds-border)] bg-[var(--ds-surface)] px-4 py-2 text-sm font-semibold text-[var(--ds-text)] hover:bg-[var(--ds-surface-2)]"
            >
              Logout
            </button>
          </form>
        ...
        <main className="w-full rounded-2xl border border-[var(--ds-border)] bg-[var(--color-surface)] p-6">
          {children}
        </main>
      </div>
    </div>
